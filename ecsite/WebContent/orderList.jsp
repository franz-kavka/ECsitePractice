	...
	<div id="header">
		...
		<div id="main">
			...
			<table border="1">
				...
				<s:iterator value="OrderListList">
				<tr>
					...
					<td><s:form action="OrderListDeleteConfirmAction">
				...
				<s:form id="inline" action="OrderListAction">
				...
				<form id="formtop" action="OrderListAction">
					<input type="submit" id="submit" value="戻る"/>
				</form>
			</s:if>
				<div id="back">
